h1b = load '/home/hduser/Downloads/h1b/' using PigStorage('\t') as (sno, status: chararray, ename, socName, des: chararray, fullTime, wage, year: chararray, worksite,lon, lat);

h1b = filter h1b by LOWER(TRIM(status)) == 'certified';
